...
import discrepancyData from './ocr-discrepancy-report.json';
import { filterItems } from './Utility';

const DiscrepancyTable = (props) => {
  ...
  if (activeRow.state != null) {
    ...
    return (
      <div className="container mt-5">
        <h3 className="text-center">OCR Document Classification Discrepancy Results For {activeRow.state}</h3>
